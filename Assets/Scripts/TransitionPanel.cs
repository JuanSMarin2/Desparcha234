...
public class TransitionPanel : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // Al crearse, consideramos que est� cubriendo (en el centro)
        panel.anchoredPosition = centerPos;

        // Nos suscribimos a cada carga de escena para hacer la salida autom�ticamente
    ...
    // Si cambia la resoluci�n/ratio, recalculamos
    ...
    {
        // Al entrar a cualquier escena nueva: el panel est� persistente, as� que lo colocamos �cubriendo�
    ...
    /// <summary>
    /// Cubre: sube desde abajo hasta centro; cuando termina, ejecuta onCovered (ah� cargas la escena).
    /// </summary>
    ...
    /// <summary>
    /// Forzar ocultar inmediatamente el panel (sin animación).
    /// Útil si Time.timeScale = 0 o si queremos garantizar que no tape nada.
    /// </summary>
