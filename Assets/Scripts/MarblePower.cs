...
public class MarblePower : MonoBehaviour
{
    ...
    [SerializeField] private int playerIndex; // �ndice de jugador: 0..3
    ...
    [Header("Detección de dispositivo (para escalado MorePower)")]
    [Tooltip("Máximo en pulgadas para considerar PHONE (<=)")]
    [SerializeField] private float phoneMaxInches = 6.5f;
    [Tooltip("Fallback: máximo lado corto en píxeles para PHONE (<=)")]
    [SerializeField] private int fallbackPhoneShortSideMaxPx = 850;

    public int PlayerIndex => playerIndex;


    // Estado actual (patr�n State)
    ...
    // Gesti�n de colisiones entre canicas (para utilidades)
    ...
    // Ignorar empujones (colisiones) entre canicas (no usado en la versi�n con Kinematic)
    ...
    // Si termina Ghost y qued� en pared, buscar punto libre cercano
    ...
    private class GhostState : NoneState
    {
        ...
        public override void OnTurnEnded()
        {
            ...
            // Al terminar, si a�n quedan turnos sigo siendo fantasma.
